...
- Create Angular project with ng: `ng new ffcodechallenge.client --defaults --skip-install --skip-git --no-standalone `.
...
- Create project file (`ffcodechallenge.client.esproj`).
